...
<head>
    ...
    <title>Admin Settings - PESO Bongabon</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .content-wrapper { padding: 2rem 3rem; max-width: 800px; margin: 0 auto; width: 100%; }
        ...
        .form-control { width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-family: inherit; font-size: 1rem; }
        
        .btn { padding: 0.75rem 1.5rem; border-radius: 8px; font-weight: 600; cursor: pointer; border: none; color: white; background: #4b5563; transition: 0.2s; font-size: 0.95rem; }
    ...
    <main class="main-content" id="mainContent">
        <div class="top-header">
            <div class="header-left">
                ...
                <h2 style="margin: 0; font-size: 1.25rem; color: white;">Admin Settings</h2>
            </div>
        </div>
