...
<head>
    ...
    <title>Reports & Analytics - PESO Admin</title>
    ...
    <main class="main-content" id="mainContent">
        <div class="top-header">
            <div class="header-left">
                ...
                <h2 style="margin: 0; font-size: 1.25rem; color: white;">Reports</h2>
            </div>
        </div>
        ...
        <div class="content-wrapper">
            <div class="section" id="reports">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    <div class="application-card" style="margin-bottom: 0;">
                        <h4>Monthly Employment Report</h4>
                        <p style="color: #6b7280; font-size: 0.9rem; margin-bottom: 1.5rem; line-height: 1.5;">Generate official LMI (Labor Market Information) and NSRP (National Skills Registration Program) reports for a specific month.</p>
                        <a href="monthly_report.php" class="btn btn-primary" style="width: 100%; text-align: center;">Generate Report</a>
                    </div>
                    <div class="application-card" style="margin-bottom: 0;">
                        <h4>Resignation & Termination Reports</h4>
                        <p style="color: #6b7280; font-size: 0.9rem; margin-bottom: 1.5rem; line-height: 1.5;">View and monitor all employee resignations, end of contracts, and terminations reported by job seekers.</p>
                        <a href="resignation_reports.php" class="btn btn-primary" style="width: 100%; text-align: center;">View Reports</a>
                    </div>
                    <div class="application-card" style="margin-bottom: 0;">
                        <h4>Service Provider Grievances</h4>
                        <p style="color: #6b7280; font-size: 0.9rem; margin-bottom: 1.5rem; line-height: 1.5;">Review complaints reported by users regarding service providers and manage account suspensions.</p>
                        <a href="provider_reports.php" class="btn btn-danger" style="width: 100%; text-align: center;">View Grievances</a>
                    </div>
                </div>
            </div>
        </div>
