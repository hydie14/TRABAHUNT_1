...
// Check if user is logged in (Assuming role is JobSeeker or similar)
...
<head>
    ...
    <title>Browse Services - PESO Bongabon</title>
...
<body>
    <aside class="sidebar">
        ...
        <div class="user-profile" onclick="toggleProfileDropdown()">
            ...
            <div class="avatar">
                <?php echo isset($user_data['first_name']) ? strtoupper(substr($user_data['first_name'], 0, 1)) : 'J'; ?>
            </div>
            <div class="user-info">
        ...
        <div class="provider-grid">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p style="margin-top: 0.5rem;">We couldn't find any providers matching your search or filter criteria. Try adjusting your keywords.</p>
                </div>
            <?php endif; ?>
        </div>
    </main>
