...
<head>
    ...
    <title>My Service Bookings - Employer</title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header"><h1 class="page-title">My Service Bookings</h1></div>
        <?php echo $message; ?>
        <div class="section">
            <?php if ($bookings->num_rows > 0): ?>
                <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem; flex-wrap: wrap; align-items: center;">
                    ...
                    <form method="GET" style="display: flex; gap: 0.5rem; align-items: center; flex-wrap: wrap; margin: 0;">
                        ...
                        <button type="submit" style="background: #1e40af; color: white; border: none; padding: 0.75rem 1.5rem; border-radius: 6px; font-weight: 600; cursor: pointer; font-size: 0.95rem;">Filter Date</button>
                        <?php if(!empty($start_date) || !empty($end_date)): ?>
                            <a href="my_service_bookings.php" style="color: #ef4444; text-decoration: none; font-weight: 600; font-size: 0.9rem; margin-left: 0.5rem;">Clear</a>
                        <?php endif; ?>
                    </form>
                </div>
                                    ...
                                    <td>
                                        ...
                                        <?php if(!empty($booking['client_message'])): ?>
                                            <div style="font-size: 0.85rem; color: #6b7280; font-style: italic; margin-top: 0.25rem;">
                                                "<?php echo htmlspecialchars($booking['client_message']); ?>"
                                            </div>
                                        <?php endif; ?>
                                    </td>
    ...
    <script>
        ...
        ratingStars.forEach(star => {
            star.addEventListener('click', () => {
                ...
                ratingStars.forEach(s => { s.classList.toggle('selected', s.getAttribute('data-value') <= value); });
            });
        });
